...
templates['recipe'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "\n<div class=\"recipe\" data-recipeid="
    ...
    + alias4(((helper = (helper = helpers.sourceURL || (depth0 != null ? depth0.sourceURL : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"sourceURL","hash":{},"data":data}) : helper)))
    + "</p>\n</div>\n\n\n";
},"useData":true});
