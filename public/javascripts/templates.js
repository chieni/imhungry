...
templates['recipeView'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.currentUser : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
    ...
    + " stars</div>\n    <form id=\"rating-form\" class=\"form-inline\" data-recipeid="
    + alias3(alias2(((stack1 = (depth0 != null ? depth0.recipe : depth0)) != null ? stack1._id : stack1), depth0))
    + " data-servingsize="
    + alias3(alias2(((stack1 = (depth0 != null ? depth0.recipe : depth0)) != null ? stack1.servingSize : stack1), depth0))
    + " data-displaybutton="
    + alias3(((helper = (helper = helpers.displayButton || (depth0 != null ? depth0.displayButton : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"displayButton","hash":{},"data":data}) : helper)))
    + ">\n       <div class=\"serving-line\">Rate this recipe: <input class=\"form-control\" id=\"rating-input\" value="
    + alias3(alias2(((stack1 = (depth0 != null ? depth0.recipe : depth0)) != null ? stack1.rating : stack1), depth0))
    + " type=\"number\" name=\"rating\" />\n       <input type=\"submit\" value=\"Rate\" class=\"btn btn-warning\"/></div>\n     </form>\n   </div>\n  </div>\n\n\n\n\n\n</div>\n\n</div>\n</div>";
},"usePartial":true,"useData":true});
